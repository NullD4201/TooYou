...
var UserCrypto = /** @class */ (function () {
    ...
    UserCrypto.createRandomSalt = function () {
    ...
    UserCrypto.makePasswordHashed = function (password, salt) {
        return __awaiter(this, void 0, void 0, function () {
            var hashed;
            return __generator(this, function (_a) {
                hashed = crypto
...
exports.UserCrypto = UserCrypto;
exports.default = UserCrypto;
//# sourceMappingURL=UserCrypto.js.map