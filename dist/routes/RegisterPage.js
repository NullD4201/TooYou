...
var RegisterPageRouter = /** @class */ (function (_super) {
    __extends(RegisterPageRouter, _super);
    function RegisterPageRouter() {
        var _this = _super.call(this) || this;
        _this._router.get('/', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
            var _a, id, name, email, message, msg, renderRes, _b, _c, _d;
            var _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _a = ctx.query, id = _a.id, name = _a.name, email = _a.email, message = _a.message;
    ...
    return RegisterPageRouter;
}(Router_1.default));
exports.default = RegisterPageRouter;
